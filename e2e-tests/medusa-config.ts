// Mirror of integration-tests/medusa-config.ts — kept standalone so the e2e
// stack owns its own Medusa project and never references apps/. If the
// integration-tests config drifts, update this copy to match.
...
module.exports = withMercur({
  ...
  modules: [
    ...
    },
    {
      ...
      options: { appDir: '', path: '/seller', disable: true },
    },
  ],
})
